...
export const GUIAS = {
    ...
    'reportes-contables': {
        ...
        pasos: [
            'Auxiliar de cuentas contables: elige el periodo y UNA cuenta en el selector (una cuenta-mayor como 115 incluye todas sus subcuentas; "Todas las cuentas" trae el auxiliar completo). Haz clic en una póliza para ver su detalle; "Exportar CSV" baja una fila por movimiento.',
